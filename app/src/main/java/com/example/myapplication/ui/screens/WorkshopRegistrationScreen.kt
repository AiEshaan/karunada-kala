        ...
        Scaffold(
            ...
            topBar = {
                LargeTopAppBar(
                    title = { 
                        Column {
                            Text("WORKSHOP", style = MaterialTheme.typography.labelSmall, letterSpacing = 2.sp, color = KarnatakaRed)
                            Text("Registration", style = MaterialTheme.typography.headlineMedium, fontWeight = FontWeight.Bold, color = TempleGreen)
                        }
                    },
                    navigationIcon = {
                        IconButton(onClick = { 
